...
// Pins
const uint8_t PIN_SENSOR_PWR     = 7;    // MOSFET gate for JSN‑SR04T VCC
...
void setup() {
  ...
  Serial.begin(9600);
  Serial.println(F("=== Bin Sensor System Starting ==="));
  delay(5000);
}
...
// Trigger HC‑SR04 / JSN‑SR04T, return cm (or –1 on timeout)
long measureDistance() {
